...
<%--@elvariable id="gameState" type="nl.Servlet.GameState"--%>
<html>
<head>
        ...
        <div id="gameboard">
            <div class="fieldcontainer" id="p2fieldcontainer">
                <div class="holecontainer" id="p2holecontainer">
                    ...
                    <div class="${holep2}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=13'">
                        <c:out value="${gameState.stonesInFieldList[12]}"/>
                    </a></div>
                    <div class="${holep2}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=12'">
                        <c:out value="${gameState.stonesInFieldList[11]}"/>
                    </a></div>
                    <div class="${holep2}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=11'">
                        <c:out value="${gameState.stonesInFieldList[10]}"/>
                    </a></div>
                    <div class="${holep2}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=10'">
                        <c:out value="${gameState.stonesInFieldList[9]}"/>
                    </a></div>
                    <div class="${holep2}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=9'">
                        <c:out value="${gameState.stonesInFieldList[8]}"/>
                    </a></div>
                    <div class="${holep2}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=8'">
            ...
            <div class="fieldcontainer" id="p1fieldcontainer">
                ...
                <div class="holecontainer" id="p1holecontainer">
                    <div class="${holep1}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=1'">
                        <c:out value="${gameState.stonesInFieldList[0]}"/>
                    </a></div>
                    <div class="${holep1}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=2'">
                        <c:out value="${gameState.stonesInFieldList[1]}"/>
                    </a></div>
                    <div class="${holep1}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=3'">
                        <c:out value="${gameState.stonesInFieldList[2]}"/>
                    </a></div>
                    <div class="${holep1}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=4'">
                        <c:out value="${gameState.stonesInFieldList[3]}"/>
                    </a></div>
                    <div class="${holep1}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=5'">
                        <c:out value="${gameState.stonesInFieldList[4]}"/>
                    </a></div>
                    <div class="${holep1}"><a
                            onclick="location.href='${pageContext.request.contextPath}mancalaServlet?hole=6'">
